...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    for (int i = 0; i < _cart.items.length; i++) {
      _qtyControllers[i] =
          TextEditingController(text: '${_cart.items[i].quantity}');
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide: const BorderSide(
                            color: AppColors.accent1, width: 1.5),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                        borderSide: const BorderSide(
                            color: AppColors.accent1, width: 2),
                      ),
                    ),
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(
                        fontSize: 12, color: AppColors.accent1),
                  ),
                ],
              ),
            ),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            color:
                isTotal ? AppColors.textPrimary : AppColors.textMuted,
          ),
        ),
        Text(
          value,
